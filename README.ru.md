...
- [Сборка проекта](docs/BUILD.ru.md)
- [Публикация обновлений лаунчера](docs/PUBLISH_LAUNCHER.ru.md)
- [Публикация модов](docs/PUBLISH_MODS.ru.md)
- [Формат обновлений](docs/UPDATE_FORMAT.ru.md)

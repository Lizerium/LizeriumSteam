...
namespace TestApp
{
    public partial class Form1 : Form
    {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            autoUpdater.Updated += new EventHandler<StateErrorUpdate>(autoUpdater_Updated);
            autoUpdater.Start();
        ...
        void autoUpdater_Updated(object sender, StateErrorUpdate e)
        {
        ...
        private async void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (info.HasUpdate)
            {
                await manager.DoUpdate(info, updateTokenSource.Token);
                MessageBox.Show("Updated");
            }
            else
            {
